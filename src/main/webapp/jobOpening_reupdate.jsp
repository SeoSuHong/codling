    ...
    <header>
        <div id="menu-bar">
            ...
            <a href="index.jsp"><img src="img/logo.png" alt="logoimg" id="logoimg"></a>
                <div id="profile-box">
                    <div id="hover-box"><img src="img/profile.png" alt="mypagelogo" id="profilelogo"><span id="mename">사용자</span> &nbsp;&nbsp;</div>
                </div>
        </div>
        <div id="profile-hover">
            <ul>
                <li id="mypage"><a href="#"><span>내 정보</span></a></li>
                <li id="resume"><a href="job_opening_management.jsp"><span>공고 관리</span></a></li>
            ...
            <article id="companyinfo">
                <form action="" method="post" name="">
                    <table>
                        <tr>
                            <td>회사명</td>
                            <td id="font_medium">(주) 이젠주식회사</td>
                        </tr>
                        <tr>
                            <td>근무지역*</td>
                            <td id="font_medium"><input name="address" id="address" size="60"placeholder="주소" readonly><button id="companyinfo_btn" onclick="findAddr()">주소찾기</button></td>
                        </tr>
                        <tr>
                            <td></td>
