    ...
    <header>
        <div id="scroll-header">
          <div id="scroll-header-box">
            ...
            <form action="search" id="searbox" name="topSearchForm">
            	<input id="search" name="search" class="searchbox" placeholder="검색어를 입력하세요.">
            </form>
	            <input type="button" form="searbox" class="btn-search" onclick="topSearch()">
      ...
      <div id="default-header">
        <div id="login_header">
          <a href="index"><img src="img/logo.png" alt="logoimg" id="logoimg"></a>
          <form id="searbox" action="search" name="searchForm">
          	<input id="search" name="search" class="searchbox" placeholder="검색어를 입력하세요." autocomplete="off" onfocus="showSearch()"></form>
          <button type="button" form="searbox" class="btn-search" onclick="search()"></button>
